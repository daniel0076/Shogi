...
COLORS = [b, w] = range(2)
COLORS_OUT = ['b', 'w']
SYMBOLS = [NONE, P, N, L, B, R, S, G, K, PRO_P, PRO_N, PRO_L, PRO_B, 
        PRO_R, PRO_S] = range(15)
PIECE_SYMBOLS = ['', 'p', 'n', 'l', 'b', 'r', 's', 'g', 'k', 
        '+p', '+n', '+l', '+b', '+r', '+s'] 
PROMOTED_PIECE = [NONE, P, N, L, B, R, S, G, K, P, N, L, B, R, S]
PIECE_PROMOTE = [NONE, PRO_P, PRO_N, PRO_L, PRO_B, PRO_R, PRO_S, 
