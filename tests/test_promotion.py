...
class TestPromotion:
    ...
    def test_do_promote(self, selenium):
        ...
        button = selenium.find_element_by_xpath("//div[@class='ant-modal-confirm-btns']/button[2]").send_keys(Keys.ENTER)
        time.sleep(1)
        promoted_chess = wait.until(presence_of_element_located((By.XPATH, "//table[@class='battlefield']/tbody/tr[3]/td[7]//img")))
        # promoted img
        assert promoted_chess.get_attribute('src') == "http://localhost:4200/assets/koma/sgl28.png"

    def test_cancel_promote(self, selenium):
        wait = WebDriverWait(selenium, 5)
        ...
        wait.until(presence_of_element_located((By.XPATH, "//table[@class='battlefield']/tbody/tr[3]/td[7]//img")))
        wait.until(presence_of_element_located((By.XPATH, "//*[contains(text(),'" + '昇變' + "')]")))
        selenium.find_element_by_xpath("//div[@class='ant-modal-confirm-btns']/button[2]").send_keys(Keys.ESCAPE)
        time.sleep(1)
        promoted_chess = wait.until(presence_of_element_located((By.XPATH, "//table[@class='battlefield']/tbody/tr[3]/td[7]//img")))
        # not promoted chess img
        assert promoted_chess.get_attribute('src') == "http://localhost:4200/assets/koma/sgl08.png"